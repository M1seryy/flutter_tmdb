...
class ModelProviderStateFull<Model extends ChangeNotifier> extends StatefulWidget {
  final Widget child;
  final bool isManagingModel;
  final Model Function() create;

  const ModelProviderStateFull({
    Key? key,
    required this.child,
  ...
  @override
  _ModelProviderStateFullState<Model> createState() =>
      _ModelProviderStateFullState<Model>();
...
class _ModelProviderStateFullState<Model extends ChangeNotifier>
    extends State<ModelProviderStateFull<Model>> {
